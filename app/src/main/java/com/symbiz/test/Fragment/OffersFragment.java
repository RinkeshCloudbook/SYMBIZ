...
import com.symbiz.test.Adapter.OfferAdapter;
...
public class OffersFragment extends Fragment {
    ...
    List<SearchListModel> offerList = new ArrayList();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        loadVcardOfferData(uId,base_url);

        return mView;
    }

    private void loadVcardOfferData(String uId, String base_Url) {
                        ...
                        try {
                            ...
                            if(object.getString("status").equalsIgnoreCase("200")){
                                ...
                                Glide.with(getActivity()).load(SM.SMBgImage)
                                        .into((ImageView) mView.findViewById(R.id.img_offerbanner));
                                Glide.with(getActivity()).load(SM.SMlogoPath)
                                        .into((CircularImageView) mView.findViewById(R.id.image_offer));

                                ((TextView) mView.findViewById(R.id.txt_offercompanyName)).setText(SM.SMcName);
                                ...
                                ((ImageView) mView.findViewById(R.id.img_offercalling)).setOnClickListener(new View.OnClickListener() {
                                    @Override
                                    public void onClick(View v) {
                                        Log.e("TEST","Calling");
                                ...
                                OfferAdapter offeradapter = new OfferAdapter(OffersFragment.this,offerList);
                                rv_offerList.setAdapter(offeradapter);
