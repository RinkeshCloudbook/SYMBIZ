                        ...
                        try {
                            ...
                            if(object.getString("status").equalsIgnoreCase("200")){
                                ...
                                Glide.with(getActivity()).load(SM.SMBgImage)
                                        .into((ImageView) mView.findViewById(R.id.img_servicebanner));

                                Glide.with(getActivity()).load(SM.SMlogoPath)
                                        .into((CircularImageView) mView.findViewById(R.id.image_service));
                                ((TextView) mView.findViewById(R.id.txt_serviceCompanyName)).setText(SM.SMcName);
                                ...
                                ((ImageView) mView.findViewById(R.id.img_servicecalling)).setOnClickListener(new View.OnClickListener() {
                                    @Override
                                    public void onClick(View v) {
                                        Log.e("TEST","Calling");
                                ...
                                rv_serviceList.setAdapter(cardadapter);
